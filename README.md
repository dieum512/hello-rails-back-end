...
**Hello rails back end** is an API built with RoR and the
...
- [ ] **Connect the app to a react app**
...
Feel free to check the [issues page](https://github.com/dieum512/hello-rails-back-end/issues).
...
I would like to thank microverse for providing us training in RoR
